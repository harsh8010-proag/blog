        ...
        <div>
            <div className='grid grid-cols-1 lg:grid-cols-4 gap-12 mt-16 '>
                <div className='sm:col-span-4'>
                    {data?.map((blog) => <div key={blog.id} className=' grid grid-cols-1 sm:grid-cols-3 gap-6 pb-10 border-b border-gray-200'>

                        <div className='col-span-1 h-[240px] bg-center bg-cover rounded-2xl mt-10' style={{ backgroundImage: `url(${blog.image})` }}></div>
                        <div className='col-span-2 flex flex-col justify-center gap-6 '>
                            ...
                            <div className='flex items-center justify-between'>
                                <div className=' flex   gap-2'>
                                    ...
                                    <p className='text-sm text-gray-800'>{blog.authorname} </p>
                                </div>
                                {isUser &&
                                    <div className='flex gap-2'>
